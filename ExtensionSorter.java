...
public class ExtensionSorter {
    public static void main(String[] args) {
        String path = "C:\\Users\\Chase\\Downloads\\SortPractice";
        ...
        for (File e : downloadDir) {
            if (e.isFile()) {
                ...
                File f = new File("C:\\Users\\Chase\\Downloads\\SortPractice\\" + temp[temp.length - 1]);

                if (f.mkdir()) {
                    System.out.println("Directory is created");
                    try {
                        File fileLoc = new File("C:\\Users\\Chase\\Downloads\\SortPractice\\" + temp[temp.length-1] + "\\"+ e.getName());
